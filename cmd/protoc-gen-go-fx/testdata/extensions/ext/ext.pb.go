...
// source: cmd/protoc-gen-go-fx/testdata/extensions/ext/ext.proto

package ext

import (
	base "gitlab.lainuoniao.cn/rhinobird/backend/protobuf.git/cmd/protoc-gen-go-fx/testdata/extensions/base"
	extra "gitlab.lainuoniao.cn/rhinobird/backend/protobuf.git/cmd/protoc-gen-go-fx/testdata/extensions/extra"
...
var file_cmd_protoc_gen_go_testdata_extensions_ext_ext_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "cmd/protoc-gen-go-fx/testdata/extensions/ext/ext.proto",
	},
	{
		ExtendedType:  (*base.BaseMessage)(nil),
