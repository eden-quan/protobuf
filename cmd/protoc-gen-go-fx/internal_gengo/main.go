...
func genGeneratedHeader(gen *protogen.Plugin, g *protogen.GeneratedFile, f *fileInfo) {
	g.P("// Code generated by protoc-gen-go-fx. DO NOT EDIT.")
	...
	if GenerateVersionMarkers {
		...
		g.P("// \tprotoc-gen-go-fx ", protocGenGoVersion)
...
func genMessageField(g *protogen.GeneratedFile, f *fileInfo, m *messageInfo, field *protogen.Field, sf *structFields) {
	...
	// extract tags
	tags = extractMoreTags(tags, field)
	...
	if flatten, isFlatten := extractFlatten(m, field); isFlatten {
		...
		g.P(leadingComments,
			name, " ", goType, tags,
			trailingComment(cleanupTags(field.Comments.Trailing.String())))
	}
